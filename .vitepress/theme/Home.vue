              ...
              <div class="w-full flex-none">
                <div class="lg:-mr-18">
                  <div class="relative z-10 rounded-lg shadow-xl text-slate-900 mx-auto sm:w-[564px] md:w-[764px] dark:text-slate-300">
                    <div class="bg-white rounded-lg overflow-hidden ring-1 ring-slate-900/5 dark:bg-slate-800/70 dark:highlight-white/5 dark:ring-0 flex p-8">
...
export default {
  components: { SearchBox, Logo, IconGitHub, IconCopy, OutLink, DarkModeSwitch, PageHeader },
  setup() {
